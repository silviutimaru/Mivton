 ...
 * Run this on Railway to ensure silviu@mivton.com has admin privileges
 */

const { Pool } = require('pg');

async function setupProductionAdminUser() {
    ...
    try {
        ...
        if (finalUser.is_admin) {
            ...
            console.log('3. Verify: Admin button should be visible');
            console.log('4. Test with other users: Admin button should be hidden');
        } else {
...
// Run the setup
setupProductionAdminUser().catch(console.error);
